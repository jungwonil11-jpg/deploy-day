...
3. 네트워크 통신
앱은 자체 서버를 운영하지 않으며 입력 데이터를 외부로 전송하지 않습니다. 단, UI 폰트를 최초 표시할 때 Google Fonts 서버에서 폰트 파일을 내려받을 수 있으며, 이 과정에서 기기의 IP 주소가 Google에 전달될 수 있습니다. 이는 폰트 로딩 외의 목적으로 사용되지 않습니다.
